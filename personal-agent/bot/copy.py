...
HELP_TEXT = (
    ...
    "<b>🌐 Переводчик</b>\n"
    "Кнопка «🌐 Переводчик» — автоопределение языка\n"
    "Иностранный текст → русский; русский → English (сменить: /translate_lang en)\n"
...
TRANSLATE_PROMPT = (
    ...
    "• любой язык → <b>русский</b> (испанский, английский и др.)\n"
    "• русский → <b>English</b> (или /translate_lang es, de, fr…)\n\n"
    "Сначала нажмите 🌐 Переводчик, потом говорите/пишите.\n"
    "Иначе голосовое может стать задачей.\n\n"
