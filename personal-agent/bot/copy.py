WELCOME = (
    ...
    "🚗 <b>Пробки</b> — мониторинг маршрута (/traffic)\n"
    ...
    "💡 Блокнот-Идеи · 🚗 Пробки · 💓 /pulse · 🌙 /night\n"
...
HELP_TEXT = (
    ...
    "<b>🚗 Пробки</b> (= /traffic)\n"
    "Мониторинг маршрута с уведомлениями при задержке.\n"
    "🇷🇺 Россия — Яндекс Карты или 2ГИС\n"
    "🌍 Остальной мир — Google Maps\n"
    "Кнопка 🚗 Пробки → 📍 Настроить маршрут\n\n"
