...
HELP_TEXT = (
    ...
    "<b>🌐 Переводчик</b>\n"
    "Кнопка «🌐 Переводчик» — отдельный режим только для перевода\n"
    "/translate_off — выйти из режима переводчика\n\n"
    "<b>Команды задач</b>\n"
    "/tasks — все активные\n"
    "/done &lt;id&gt; · /cancel &lt;id&gt;\n"
...
TRANSLATE_PROMPT = (
    "🌐 <b>Режим переводчика активен</b>\n"
    "Целевой язык: <b>{lang}</b>\n\n"
    "Отправьте текст или голосовое — я переведу.\n"
    "Чтобы создать задачу — нажмите «❌ Выйти» или любую другую кнопку меню."
)
TRANSLATE_RESULT = (
