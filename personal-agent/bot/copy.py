WELCOME = (
    ...
    "💡 <b>Блокнот-Идеи</b> — идеи, мысли, траты, решения (/journal)\n"
    "🚗 <b>Монитор траффика</b> — маршрут или район/улица/город (/traffic)\n"
    "🔍 <b>Разведка и Вериф</b> — мониторинг источников и проверка фактов (/recon)\n"
    ...
    "💡 Блокнот-Идеи · 🚗 Монитор траффика · 💓 /pulse · 🌙 /night\n"
...
HELP_TEXT = (
    ...
    "<b>💡 Блокнот-Идеи</b> (= /journal, /notes)\n"
    "Единое место для идей, мыслей, трат и решений.\n"
    "Нажми кнопку — пиши или диктуй, AI разложит по категориям.\n"
    "Также: «Заметка: текст» или «Идея: …» в обычном чате.\n"
    "Кнопки: 💡 Идеи · 📊 Сводка · 📅 Вчера\n"
    "/journal summary — сводка дня\n\n"
    "<b>📅 Календарь</b>\n"
    ...
    "<b>🚗 Монитор траффика</b> (= /traffic)\n"
    "Два режима:\n"
    "🛣 <b>Маршрут</b> — от точки А до Б, уведомления при задержке\n"
    "🏙 <b>Район/улица/город</b> — загруженность дорог вокруг места\n"
    "🇷🇺 Россия — Яндекс или 2ГИС · 🌍 мир — Google Maps\n"
    "Кнопка 🚗 Монитор траффика → 🛣 или 🏙\n\n"
    "<b>🔍 Разведка и Вериф</b> (= /recon)\n"
    "Мониторинг сайтов, Telegram, эко-календаря.\n"
    "Верификация: /recon verify … или <code>вериф: текст</code>\n\n"
