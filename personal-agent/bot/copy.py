WELCOME = (
    "Привет, {name}! Я твой <b>личный агент</b>.\n\n"
    "Напоминаю о делах, веду заметки, синхронизирую с Google Calendar "
    "и перевожу текст.\n\n"
    "<b>Пример:</b> «Завтра в 9:00 напомни позвонить маме»\n\n"
    "Сначала укажи часовой пояс: /timezone\n"
    "Подробнее: /help"
)
