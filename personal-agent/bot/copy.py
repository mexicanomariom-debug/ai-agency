WELCOME = (
    ...
    "💡 <b>Блокнот-Идеи</b> — умный дневник: идеи, траты, решения (/journal)\n"
...
HELP_TEXT = (
    ...
    "<b>💡 Блокнот-Идеи</b> (= /journal)\n"
    "Умный дневник: идеи, мысли, траты, решения, настроение.\n"
    "Нажми кнопку — пиши или диктуй, AI сам разложит по категориям.\n"
