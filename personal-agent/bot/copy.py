WELCOME = (
    ...
    "<b>💓 Пульс</b> — утром обзор дня, днём пишу только если важно\n"
    "<b>🌊 Ambient</b> — ловлю траты, мысли и решения из обычного чата\n"
    "<b>🌙 Ночью</b> — итог дня и вопрос на завтра\n\n"
...
HELP_TEXT = (
    ...
    "(выключить: /pulse off)\n\n"
    "<b>💓 Пульс</b> — умный обзор утром, днём только если важно\n"
    "<b>🌊 Ambient</b> — из обычного чата: траты, мысли, решения\n"
    "<b>🌙 Ночью</b> — итог дня (/night 21)\n"
    "<b>📔 /journal</b> — что записано за сегодня\n\n"
    "<b>🚗 Пробки</b>\n"
    "/traffic — мониторинг маршрута, уведомления при задержке\n\n"
